...
import {
  ...
  bulkPendingDraftApproveOutputSchema,
...
export const createApiClient = (options: ApiClientOptions) => ({
  ...
  setDocumentTypeHidden: (
    ...
    request(
      options,
      API_ROUTES.documentTypeSetHidden.method,
      pathWith(API_ROUTES.documentTypeSetHidden.path, { slug }),
      documentTypeSetHiddenOutputSchema,
      input,
      signal,
    ),
  listHiddenFilterValues: (signal?: AbortSignal) =>
    request(
      options,
      API_ROUTES.hiddenFilterValues.method,
      API_ROUTES.hiddenFilterValues.path,
      hiddenFilterValueListOutputSchema,
      undefined,
      signal,
    ),
  hideFilterValue: (input: HiddenFilterValueRef, signal?: AbortSignal) =>
    request(
      options,
      API_ROUTES.hiddenFilterValueHide.method,
      API_ROUTES.hiddenFilterValueHide.path,
      hiddenFilterValueHideOutputSchema,
      input,
      signal,
    ),
  unhideFilterValue: (input: HiddenFilterValueRef, signal?: AbortSignal) =>
    request(
      options,
      API_ROUTES.hiddenFilterValueUnhide.method,
      API_ROUTES.hiddenFilterValueUnhide.path,
      hiddenFilterValueUnhideOutputSchema,
      input,
      signal,
    ),
  ...
  bulkApprovePendingDrafts: (input: BulkApprovePendingDrafts, signal?: AbortSignal) =>
    request(
      options,
      API_ROUTES.bulkPendingDraftApprove.method,
      API_ROUTES.bulkPendingDraftApprove.path,
      bulkPendingDraftApproveOutputSchema,
      input,
      signal,
    ),
