...
- `pnpm run e2e` = the **browser** gate: Playwright drives real browsers over
  ...
  covers all six spec files (14 tests), and WebKit reruns `documents.spec.ts` to
  pin the Safari/pdf.js legacy regression (18 test executions total):
  ...
  stamp placement; draft-filter approve roundtrip),
