...
export const actions = {
  ...
  setDocumentTypeHidden: setDocumentTypeHiddenMutation(apiClient),
  documentTypesInvalidates,
  hiddenFilterValues: hiddenFilterValuesQuery(apiClient),
  hideFilterValue: hideFilterValueMutation(apiClient),
  unhideFilterValue: unhideFilterValueMutation(apiClient),
  hiddenFilterValuesInvalidates,
