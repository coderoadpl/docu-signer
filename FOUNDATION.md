...
- Draft-scoped API tokens create draft document links and comments awaiting human approval; the draft state is visibility-only and supersedes the transiently shipped unrestricted annotation writes (owner decision 2026-08-16, archived verbatim in [docs/owner-rulings.md](docs/owner-rulings.md)).
- Draft-scoped API tokens may propose document metadata changes against any document for human approval or rejection; documents with any pending draft source show a title dot and are searchable with the pending-drafts filter (owner decision 2026-08-16, archived verbatim in [docs/owner-rulings.md](docs/owner-rulings.md)).
