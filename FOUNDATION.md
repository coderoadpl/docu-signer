...
- Draft-scoped API tokens may propose document metadata changes against any document for human approval or rejection; documents with any pending draft source show a title dot and are searchable with the pending-drafts filter (owner decision 2026-08-16).
